Criação de um aplicativo para Cadastro de alunos, sendo usado chatgpt para criação de bases de html, css e para criação de testes unitários e de componentes.
